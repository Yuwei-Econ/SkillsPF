...
mus <- c(0,3)
Sigmas <- cbind(c(0.1,0.05), c(0.05, 0.1))

logx <- rmvnorm(1000, mu=mus, sigma=Sigmas)
...
### normal
u <- rnorm(1000, mean = 0, sd = 0.002) #for use with lognormal x's
...
save(list = ls(all.names = TRUE), file = "Full simulations/Output/single normal 070416.RData")
