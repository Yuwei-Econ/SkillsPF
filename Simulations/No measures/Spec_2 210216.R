...
logx <- rmvnorm.mixt(5000, mus=mus, Sigmas=Sigmas, props=props)
...
### normal
u <- rnorm(5000, mean = 0, sd = 0.02) #for use with lognormal x's
...
#save(list = ls(all.names = TRUE), file = "Full simulations/Output/Spec_2 220216.RData")
