...
t <- 0.5
mus <- rbind(c(0,1), c(1,0)) # first two entries are first mixture
Sigmas <- rbind(cbind(c(0.5,0.05), c(0.05, 0.5)), cbind(c(0.3,-0.1), c(-0.1, 0.5)))
props <- c(t, 1-t)
...
save(list = ls(all.names = TRUE), file = "Full simulations/No measures/Additional specifications/Spec_A 260216.RData")
