...
t <- 0.3
mus <- rbind(c(3,5), c(4,4)) # first two entries are first mixture
Sigmas <- rbind(cbind(c(1,0.5), c(0.5, 1)), cbind(c(2,-0.3), c(-0.3, 1)))
props <- c(t, 1-t)
...
save(list = ls(all.names = TRUE), file = "Full simulations/No measures/Additional specifications/Spec_B 260216.RData")
