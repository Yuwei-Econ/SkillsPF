...
t <- 0.3
mus <- rbind(c(1,1), c(1,1.1)) # first two entries are first mixture
...
save(list = ls(all.names = TRUE), file = "Full simulations/No measures/Additional specifications/Spec_D 260216.RData")
