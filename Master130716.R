...
bootstrap <- 0 # set = 1 if running bootstrap
...
if (bootstrap == 0 | k == 1) {
measures <- read.dta13("/Users/Jack/Dropbox/Documents/Projects/China/Project Parenting/R Analysis/Data/measures020416.dta", # measures file in .dta
                       convert.factors = F)
